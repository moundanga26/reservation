    ...
    <>
      <div className='aboutCard mtop flex_space'>
        <div className='row row1'>
          ...
          <h1>
            Nous vous <span>fournissons une solution</span> pour que votre séjour soit agréable et doux.
          </h1>
          ...
          <button className='secondary-btn'>
            Voir plus <i className='fas fa-long-arrow-alt-right'></i>
          </button>
        </div>
        <div className='row image'>
          <img src='/images/Hotellerie.jpg' alt='' />
